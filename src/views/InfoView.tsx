    ...
    <div className="page">
      ...
      <div className="grid-2">
        ...
        <section className="card">
          ...
          <p className="hint">
            업무강도는 보직의 부담 정도입니다(예: 정감독 100, 부감독 50, 대기실 감독 30). 위에 있는 보직부터, 누적 업무강도가 낮은 교사에게 먼저 배정되고
            마지막에 교사 간 업무강도가 고르게 되도록 조정됩니다.
            <br />
            고교학점제로 시험이 없는 학생의 <b>대기실</b>이 생기면, 고사실 목록에 “대기실”을 추가하고 이 표의 “대기실 감독”을 함께 쓰세요. 대기 학생이 없는
            교시는 [필요 감독 수]에서 비워 두면 감독표에도 나타나지 않습니다.
          </p>
        </section>
      </div>
